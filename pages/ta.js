        ...
        <Card className={this.props.card}>
          <CardContent>
            <Typography className={this.props.title} color="textSecondary" gutterBottom>
              Course: {this.props.info.department} {this.props.info.level}
            </Typography>
            <Typography className={this.props.title} color="textSecondary" gutterBottom>
              Semester: {this.props.info.year_semester}
            </Typography>
          </CardContent>
          <CardActions>
            <Button onClick={() => Router.push(`/editTA?netid=${this.props.netid}`)} size="small"> Edit </Button>
          </CardActions>
        </Card>
      </div>
    )
