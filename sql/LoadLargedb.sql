...
FROM '/vagrant/Project/DukeStudy-master/CS316_Final_Project/professor.csv' DELIMITER ',';
...
FROM '/vagrant/Project/DukeStudy-master/CS316_Final_Project/student.csv' DELIMITER ',';

COPY Tutor(NetID, Rate_Per_Hour, Days_Available)
FROM '/vagrant/Project/DukeStudy-master/CS316_Final_Project/tutor.csv' DELIMITER ',';

COPY Tutors_For(NetID, Course_Number)
FROM '/vagrant/Project/DukeStudy-master/CS316_Final_Project/tutors_for.csv' DELIMITER ',';

COPY Teaches_Course(Professor_NetID, Course_Number, Year_Semester, When_Class_Meets, Location)
FROM '/vagrant/Project/DukeStudy-master/CS316_Final_Project/teaches_course.csv' DELIMITER ',';
...
FROM '/vagrant/Project/DukeStudy-master/CS316_Final_Project/tas_course.csv' DELIMITER ',';

COPY Study_Group(Group_ID, Course_Number, Year_Semester)
FROM '/vagrant/Project/DukeStudy-master/CS316_Final_Project/study_group.csv' DELIMITER ',';

COPY Takes_Course(NetID, Course_Number, Year_Semester, Grade)
FROM '/vagrant/Project/DukeStudy-master/CS316_Final_Project/takes_course.csv' DELIMITER ',';

COPY Rates_Course(NetID, Course_Number, Year_Semester, Quality_Of_Course, Quality_Of_Instruction, Difficulty, Workload)
FROM '/vagrant/Project/DukeStudy-master/CS316_Final_Project/rates_course.csv' DELIMITER ',';
